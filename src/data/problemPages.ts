...
export const problemPages: ProblemPage[] = [
  ...
  },
  {
    ...
    shortTitle: "HEIC JPG",
    description: "iPhone HEIC 사진이 열리지 않거나 업로드가 막힐 때 JPG로 바꿉니다.",
    metaDescription:
      "HEIC JPG 변환, 아이폰 사진 JPG 변환, HEIC 제출 오류를 무료로 처리하세요. 브라우저에서 변환하고 파일은 서버로 전송되지 않습니다.",
    primaryQuery: "HEIC JPG 변환",
    secondaryQueries: ["아이폰 사진 JPG 변환", "HEIC 제출 오류", "아이폰 사진 업로드 안됨"],
    intentQueries: [
      "아이폰 사진 안열림",
      "아이폰 사진 업로드 안됨",
      "heic 파일 안열림",
    ...
    targetLabel: "HEIC JPG 변환 시작",
    targetPreset: "jpg",
    heroBadges: ["무료", "설치 없음", "서버 전송 없음"],
    actionNote: "JPG 출력 기본값으로 열어 iPhone 사진 업로드 호환성을 먼저 맞춥니다.",
    steps: ["HEIC 사진 선택", "JPG 출력 확인", "변환 파일 저장", "필요하면 1MB 압축"],
    faqs: [
  ...
  },
  {
    ...
    title: "사진 크기 제한 맞추기",
    shortTitle: "크기 제한",
    description: "가로·세로 픽셀 제한이나 해상도 초과가 뜰 때 긴 변 1200px 기준으로 줄입니다.",
    metaDescription:
      "사진 크기 제한, 이미지 픽셀 줄이기, 1200px 리사이즈를 무료로 처리하세요. 브라우저에서 크기를 줄이고 파일은 서버로 전송되지 않습니다.",
    primaryQuery: "사진 크기 제한",
    secondaryQueries: ["이미지 픽셀 줄이기", "사진 해상도 줄이기", "1200px 리사이즈"],
    intentQueries: [
      "가로 세로 제한",
      "픽셀 제한",
      "해상도 초과",
    ...
    targetLabel: "1200px 리사이즈 시작",
    targetPreset: "long-1200",
    heroBadges: ["무료", "설치 없음", "서버 전송 없음"],
    actionNote: "긴 변 1200px 기본값으로 열어 비율을 유지하고 제출 가능한 크기로 맞춥니다.",
    steps: ["사진 선택", "긴 변 1200px 확인", "리사이즈 저장", "용량도 크면 1MB 압축"],
    faqs: [
  ...
  },
  {
    ...
    title: "사진 방향 바로잡기",
    shortTitle: "방향 오류",
    description: "스캔본이나 휴대폰 사진이 옆으로 보일 때 오른쪽 90도 회전으로 바로잡습니다.",
    metaDescription:
      "사진이 옆으로 보일 때 스캔본 회전, JPG 90도 회전을 무료로 처리하세요. 브라우저에서 회전하고 파일은 서버로 전송되지 않습니다.",
    primaryQuery: "사진 방향 돌리기",
    secondaryQueries: ["사진이 옆으로", "스캔본 회전", "JPG 90도 회전"],
    intentQueries: [
      "사진이 옆으로",
      "사진 옆으로 돌아감",
      "스캔본 옆으로",
    ...
    targetLabel: "오른쪽 90도 회전 시작",
    targetPreset: "right",
    heroBadges: ["무료", "설치 없음", "서버 전송 없음"],
    actionNote: "오른쪽 90도 회전 기본값으로 열어 옆으로 누운 사진 방향을 먼저 바로잡습니다.",
    steps: ["사진 선택", "오른쪽 90도 확인", "회전 파일 저장", "여백이 크면 자르기"],
    faqs: [
  ...
  },
  {
    ...
    title: "문서 사진 여백 자르기",
    shortTitle: "여백 자르기",
    description: "책상, 바닥, 빈 여백이 함께 찍힌 문서 사진에서 제출할 영역만 남깁니다.",
    metaDescription:
      "문서 사진 자르기, 사진 여백 제거, 스캔본 크롭을 무료로 처리하세요. 브라우저에서 필요한 영역만 자르고 파일은 서버로 전송되지 않습니다.",
    primaryQuery: "문서 사진 자르기",
    secondaryQueries: ["사진 여백 제거", "스캔본 크롭", "이미지 자르기"],
    intentQueries: [
      "문서 여백 제거",
      "사진 여백 자르기",
      "스캔본 여백",
    ...
    targetLabel: "문서 영역 자르기 시작",
    targetPreset: "document",
    heroBadges: ["무료", "설치 없음", "서버 전송 없음"],
    actionNote: "문서 영역 자르기 기본값으로 열어 불필요한 배경과 여백을 먼저 줄입니다.",
    steps: ["문서 사진 선택", "문서 영역 조정", "잘라낸 파일 저장", "필요하면 방향·용량 정리"],
    faqs: [
